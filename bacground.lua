...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			TextColor = Color3.fromRGB(114, 3, 7),

			Background = Color3.fromRGB(114, 10, 108),
			Topbar = Color3.fromRGB(34, 34, 34),
			Shadow = Color3.fromRGB(114, 10, 108),

			NotificationBackground = Color3.fromRGB(20, 20, 20),
			NotificationActionsBackground = Color3.fromRGB(230, 230, 230),

			TabBackground = Color3.fromRGB(114, 10, 108),
			TabStroke = Color3.fromRGB(85, 85, 85),
			TabBackgroundSelected = Color3.fromRGB(210, 210, 210),
			TabTextColor = Color3.fromRGB(240, 240, 240),
			SelectedTabTextColor = Color3.fromRGB(50, 50, 50),

			ElementBackground = Color3.fromRGB(114, 10, 108),
		...
		Ocean = {
			...
			TabBackgroundSelected = Color3.fromRGB(114, 3, 7),
			TabTextColor = Color3.fromRGB(114, 7, 3),
			SelectedTabTextColor = Color3.fromRGB(114, 10, 108),
